...
// Error messages
static string ERROR_INVALID_MEMO = "ramx.eos: invalid memo (ex: \"buyorder,<price>\" or \"buy,<order_ids>\")";
class [[eosio::contract("ramx.eos")]] ramx : public contract {
   ...
   private:
    ...
    void do_buyorder(const name& owner, const uint64_t price, const extended_asset& ext_in);
